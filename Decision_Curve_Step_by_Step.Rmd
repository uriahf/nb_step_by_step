...
- Some common questions about interpreting decision curves.
...
$$\text{TP} \neq \text{FP}$$
A good example for bad practice in evaluating performance of prediction model is the Youden's J statistics:
...
A wine importer buys €1m of wine from France and sells it in the USA for $1.5 🍷
